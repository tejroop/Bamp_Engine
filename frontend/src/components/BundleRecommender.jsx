...
/**
 * F7: Smart Bundle Recommender — Aligned with Notebook Ch.7
 *
 ...
 *
 * Key Ch.7 finding (Bundle vs Cross-sell Decomposition):
 *   TW: 35.6% of orders are pre-bundled sets (supply-side)
 *       Only 22.1% are organic cross-sell (demand-side)
 *   This distinction matters: supply-side bundles inflate attachment
 *   rates without reflecting true consumer cross-buy propensity.
 *
